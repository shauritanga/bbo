      ...
      <Page size="A4">
        <View fixed={true} style={{ flex: 1 }}>
          ...
          <View style={styles.body}>
            ...
            <View style={styles.table}>
              <Text style={styles.cell}>Quantity: {data.volume}</Text>
            </View>
            <View style={styles.table}>
            ...
            <View style={styles.table}>
              ...
              <Text style={styles.cell}>
                {Math.round((commissionTier1 + Number.EPSILON) * 100) / 100}
              </Text>
            </View>
            <View style={styles.table}>
              <Text style={[styles.cell, { flex: 2, borderRight: "none" }]}>
              ...
              <Text style={styles.cell}>
                {Math.round((commissionTier2 + Number.EPSILON) * 100) / 100}
              </Text>
            </View>
            <View style={styles.table}>
              <Text style={[styles.cell, { flex: 2, borderRight: "none" }]}>
              ...
              <Text style={styles.cell}>
                {Math.round((commissionTier3+Number.EPSILON) * 100) / 100}
              </Text>
            </View>
            <View style={styles.table}>
              <Text style={[styles.cell, { flex: 2, borderRight: "none" }]}>
            ...
            <View style={styles.table}>
              ...
              <Text style={styles.cell}>
                {Math.round((vat + Number.EPSILON) * 100) / 100}
              </Text>
            </View>
            <View style={styles.table}>
              <Text style={[styles.cell, { flex: 2, borderRight: "none" }]}>
              ...
              <Text style={styles.cell}>
                {Math.round((dseFee + Number.EPSILON) * 100) / 100}
              </Text>
            </View>
            <View style={styles.table}>
              <Text style={[styles.cell, { flex: 2, borderRight: "none" }]}>
              ...
              <Text style={styles.cell}>
                {Math.round((cmsaFee + Number.EPSILON) * 100) / 100}
              </Text>
            </View>
            <View style={styles.table}>
              <Text style={[styles.cell, { flex: 2, borderRight: "none" }]}>
              ...
              <Text style={styles.cell}>
                {Math.round((fidelityFee + Number.EPSILON) * 100) / 100}
              </Text>
            </View>
            <View style={styles.table}>
              <Text style={[styles.cell, { flex: 2, borderRight: "none" }]}>
              ...
              <Text style={styles.cell}>
                {Math.round((cdsFee + Number.EPSILON) * 100) / 100}
              </Text>
            </View>
            <View style={styles.table}>
              <Text style={[styles.cell, { flex: 2, borderRight: "none" }]}>
              ...
              <Text style={styles.cell}>{Math.round((totalCharges + Number.EPSILON) * 100) / 100}</Text>
            </View>
            <View style={styles.table}>
              <Text style={[styles.cell, { flex: 2, borderRight: "none" }]}>
                TOTAL CONSIDERATION
              </Text>
              <Text style={styles.cell}>{Math.round((totalConsideration + Number.EPSILON) * 100) / 100}</Text>
            </View>
            <View style={styles.table}>
              <Text
                style={[
