...
function useTransition(data, props, deps) {
  ...
  if (is.fun(sort3)) {
    transitions.sort((a3, b3) => sort3(a3.item, b3.item));
  }
  let delay = -trail;
  const forceUpdate = useForceUpdate();
...
function decompose_default(a3, b3, c9, d3, e6, f3) {
  ...
  if (scaleX = Math.sqrt(a3 * a3 + b3 * b3))
    a3 /= scaleX, b3 /= scaleX;
  if (skewX = a3 * c9 + b3 * d3)
    c9 -= a3 * skewX, d3 -= b3 * skewX;
...
function blurf(radius) {
  ...
  return (T2, S2, start2, stop2, step) => {
    ...
    for (let i3 = start2, j2 = stop2; i3 <= j2; i3 += step) {
      ...
      T2[i3] = (sum4 + t6 * (S2[Math.max(start2, i3 - s1)] + S2[Math.min(stop2, i3 + s1)])) / w3;
...
function formatDecimalParts(x4, p3) {
  if ((i3 = (x4 = p3 ? x4.toExponential(p3 - 1) : x4.toExponential()).indexOf("e")) < 0)
    return null;
...
var formatTypes_default = {
  "%": (x4, p3) => (x4 * 100).toFixed(p3),
  "b": (x4) => Math.round(x4).toString(2),
  "c": (x4) => x4 + "",
  "d": formatDecimal_default,
  "e": (x4, p3) => x4.toExponential(p3),
  "f": (x4, p3) => x4.toFixed(p3),
  "g": (x4, p3) => x4.toPrecision(p3),
  "o": (x4) => Math.round(x4).toString(8),
  "p": (x4, p3) => formatRounded_default(x4 * 100, p3),
...
function formatLocale(locale5) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      var string = [], i3 = -1, j2 = 0, n3 = specifier.length, c9, pad3, format3;
      if (!(date2 instanceof Date))
        date2 = /* @__PURE__ */ new Date(+date2);
      while (++i3 < n3) {
        if (specifier.charCodeAt(i3) === 37) {
          string.push(specifier.slice(j2, i3));
          if ((pad3 = pads[c9 = specifier.charAt(++i3)]) != null)
            c9 = specifier.charAt(++i3);
          else
            pad3 = c9 === "e" ? " " : "0";
          if (format3 = formats2[c9])
            c9 = format3(date2, pad3);
          string.push(c9);
          j2 = i3 + 1;
        }
      }
...
function calendar(ticks2, tickInterval, year2, month2, week, day2, hour2, minute2, second3, format3) {
  ...
  scale.copy = function() {
    return copy(scale, calendar(ticks2, tickInterval, year2, month2, week, day2, hour2, minute2, second3, format3));
  };
  return scale;
}
function time() {
...
function line_default(x4, y4) {
  ...
  function line(data) {
    ...
    for (i3 = 0; i3 <= n3; ++i3) {
      ...
      if (defined0)
        output.point(+x4(d3, i3, data), +y4(d3, i3, data));
    }
    if (buffer)
...
function pie_default() {
  ...
  function pie(data) {
    var i3, n3 = (data = array_default2(data)).length, j2, k4, sum4 = 0, index3 = new Array(n3), arcs = new Array(n3), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p3 = Math.min(Math.abs(da) / n3, padAngle.apply(this, arguments)), pa = p3 * (da < 0 ? -1 : 1), v4;
    for (i3 = 0; i3 < n3; ++i3) {
...
function controlPoints(x4) {
  ...
  for (i3 = 1; i3 < n3 - 1; ++i3)
    a3[i3] = 1, b3[i3] = 4, r3[i3] = 4 * x4[i3] + 2 * x4[i3 + 1];
  a3[n3 - 1] = 2, b3[n3 - 1] = 7, r3[n3 - 1] = 8 * x4[n3 - 1] + x4[n3];
  for (i3 = 1; i3 < n3; ++i3)
    m4 = a3[i3] / b3[i3 - 1], b3[i3] -= m4, r3[i3] -= m4 * r3[i3 - 1];
  a3[n3 - 1] = r3[n3 - 1] / b3[n3 - 1];
  for (i3 = n3 - 2; i3 >= 0; --i3)
    a3[i3] = (r3[i3] - a3[i3 + 1]) / b3[i3];
...
function formatDecimalParts2(x4, p3) {
  if ((i3 = (x4 = p3 ? x4.toExponential(p3 - 1) : x4.toExponential()).indexOf("e")) < 0)
    return null;
  var i3, coefficient = x4.slice(0, i3);
  return [
...
var prefixExponent2;
function formatPrefixAuto_default2(x4, p3) {
  var d3 = formatDecimalParts2(x4, p3);
  if (!d3)
    return x4 + "";
  ...
  return i3 === n3 ? coefficient : i3 > n3 ? coefficient + new Array(i3 - n3 + 1).join("0") : i3 > 0 ? coefficient.slice(0, i3) + "." + coefficient.slice(i3) : "0." + new Array(1 - i3).join("0") + formatDecimalParts2(x4, Math.max(0, p3 + i3 - 1))[0];
}

// node_modules/@nivo/core/node_modules/d3-format/src/formatRounded.js
function formatRounded_default2(x4, p3) {
  var d3 = formatDecimalParts2(x4, p3);
  if (!d3)
    return x4 + "";
  var coefficient = d3[0], exponent = d3[1];
...
var formatTypes_default2 = {
  ...
  "p": function(x4, p3) {
    return formatRounded_default2(x4 * 100, p3);
  },
...
function ascending_default2(a3, b3) {
...
function formatLocale2(locale5) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      ...
      while (++i3 < n3) {
        if (specifier.charCodeAt(i3) === 37) {
          string.push(specifier.slice(j2, i3));
          if ((pad3 = pads2[c9 = specifier.charAt(++i3)]) != null)
            c9 = specifier.charAt(++i3);
          else
            pad3 = c9 === "e" ? " " : "0";
          if (format3 = formats2[c9])
  ...
  function newParse(specifier, Z) {
    return function(string) {
      var d3 = newDate2(1900, void 0, 1), i3 = parseSpecifier(d3, specifier, string += "", 0), week, day2;
      if (i3 != string.length)
        return null;
      if ("Q" in d3)
        return new Date(d3.Q);
...
function formatDayOfYear2(d3, p3) {
  return pad2(1 + day_default.count(year_default(d3), d3), p3, 3);
}
...
function formatWeekNumberSunday2(d3, p3) {
  return pad2(sunday.count(year_default(d3) - 1, d3), p3, 2);
}
function dISO2(d3) {
  var day2 = d3.getDay();
...
function formatWeekNumberISO2(d3, p3) {
  d3 = dISO2(d3);
  return pad2(thursday.count(year_default(d3), d3) + (year_default(d3).getDay() === 4), p3, 2);
}
function formatWeekdayNumberSunday2(d3) {
  return d3.getDay();
}
function formatWeekNumberMonday2(d3, p3) {
  return pad2(monday.count(year_default(d3) - 1, d3), p3, 2);
}
...
function formatUTCDayOfYear2(d3, p3) {
  return pad2(1 + utcDay_default.count(utcYear_default(d3), d3), p3, 3);
}
...
function formatUTCWeekNumberSunday2(d3, p3) {
  return pad2(utcSunday2.count(utcYear_default(d3) - 1, d3), p3, 2);
}
...
function formatUTCWeekNumberISO2(d3, p3) {
  d3 = UTCdISO2(d3);
  return pad2(utcThursday2.count(utcYear_default(d3), d3) + (utcYear_default(d3).getUTCDay() === 4), p3, 2);
}
function formatUTCWeekdayNumberSunday2(d3) {
  return d3.getUTCDay();
}
function formatUTCWeekNumberMonday2(d3, p3) {
  return pad2(utcMonday2.count(utcYear_default(d3) - 1, d3), p3, 2);
}
...
function jr() {
  return jr = Object.assign ? Object.assign.bind() : function(e6) {
    for (var r3 = 1; r3 < arguments.length; r3++) {
      var t6 = arguments[r3];
      for (var n3 in t6)
        Object.prototype.hasOwnProperty.call(t6, n3) && (e6[n3] = t6[n3]);
    }
    return e6;
...
function Br(e6, r3) {
  ...
  for (n3 = 0; n3 < o3.length; n3++)
    t6 = o3[n3], r3.indexOf(t6) >= 0 || (i3[t6] = e6[t6]);
  return i3;
}
...
var Ir = function(e6, r3) {
  ...
  return Gr.forEach(function(e7) {
    (0, import_set2.default)(t6, e7, Lr((0, import_get.default)(t6, e7), t6.text));
  }), t6;
};
...
var xt = function(e6) {
  return "function" == typeof e6 ? e6 : "string" == typeof e6 ? 0 === e6.indexOf("time:") ? timeFormat2(e6.slice("5")) : format2(e6) : function(e7) {
    return "" + e7;
  };
};
var Ot = function(e6) {
...
var qn = function(e6, r3) {
  ...
  return r3 && (t6 = (0, import_isFunction.default)(r3) ? r3 : format2(r3)), t6 ? function(e7) {
    return t6(n3(e7));
  } : n3;
};
var Cn = function(e6) {
        ...
        if (f3) {
          if (Gn.includes(f3.type))
            if ("inherit" === f3.background || "inherit" === f3.color) {
              ...
              "inherit" === f3.background && (b3 = b3 + ".bg." + p3, h2 = p3), "inherit" === f3.color && (b3 = b3 + ".fg." + p3, g3 = p3), (0, import_set2.default)(r4, s4, "url(#" + b3 + ")"), c9[b3] || (u3.push(jr({}, f3, { id: b3, background: h2, color: g3 })), c9[b3] = 1);
            } else
              (0, import_set2.default)(r4, s4, "url(#" + l4 + ")");
            ...
            if (f3.colors.map(function(e7) {
              ...
              w3.id = _, (0, import_set2.default)(r4, s4, "url(#" + _ + ")"), c9[_] || (u3.push(w3), c9[_] = 1);
            } else
              (0, import_set2.default)(r4, s4, "url(#" + l4 + ")");
          }
        }
...
//# sourceMappingURL=chunk-WIDGZMEG.js.map
