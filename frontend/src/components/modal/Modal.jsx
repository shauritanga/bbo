            ...
            <form className='form'>
                ...
                <div className="row">
                    <div className="form-group">
                        ...
                        <ActionSelection label="Select Action" data={[{"name":"Buy"},{"name": "Sell"}]} setAction={setAction} />
                    </div>
                    <div className="form-group">
                        <label htmlFor="customer">Order Type</label>
                        <TypeSelection label="Select Security/Bond" data={[{"name":"Security"},{"name": "Bond"}]} setType={setType}/>
                    </div>
                </div>
                <div className="row">
                    {
                        ...
                        <div className="form-group">
                            ...
                            <SecuritySelection label="Select Security" data={security} setSecurityId = {setSecurityId} />
                        </div>
                    }
                </div>
            </form>
